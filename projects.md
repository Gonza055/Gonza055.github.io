...
<style>
/* Reusar paleta Stanford del Home */
:root {
  --proj-border: #e5e7eb;
...
/* Ocultar el título automático de la página y usar nuestro hero */
.page__title {
  display: none;
}

/* HERO tipo Stanford, alineado a la izquierda */
.projects-hero {
  max-width: 760px;
...
/* Contenido general: limitar ancho como en Home */
.page__content {
  max-width: 760px;
  margin: 0 auto;
}

/* Encabezados de secciones dentro de Projects */
.page__content h2 {
  margin-top: 2.1rem;
...
/* Bloques de proyecto – estilo limpio, académico */
.project-block {
...
/* Figuras / imágenes (por ahora placeholders) */
.project-figure {
