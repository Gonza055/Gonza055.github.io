...
<div class="projects-hero">
  ...
  <p class="projects-tagline">
    A closer look at how I work with data, build ML pipelines, and connect models to real-world decisions.
  </p>
</div>

<p class="projects-intro">
  This page highlights a few projects that emphasize end-to-end thinking: how data is collected, cleaned,
  modeled, and evaluated. The focus is less on a single metric and more on the pipeline and the decisions
  it enables.
</p>
...
<div class="project-block">
  ...
  <figure class="project-figure">
    ...
    <figcaption>
      Placeholder diagram – to be replaced with the actual pipeline figure.
    </figcaption>
  </figure>
...
<div class="project-block">
  ...
  <figure class="project-figure project-figure--grid">
    ...
    <figcaption>
      Visual material from the TrainOps work: real-world locomotive context (left) and simulation outputs
...
<div class="project-block">
  ...
  <figure class="project-figure">
    <img src="/assets/images/projects/failure-mode-placeholder.png"
         alt="Placeholder ROC and feature-importance plots for failure-mode models" />
    <figcaption>
      Placeholder plots – intended for ROC curves, feature importance, or confusion matrices.
    </figcaption>
  </figure>
...
<style>
/* ===== Stanford-style palette (match Home) ===== */
:root {
  --proj-border: #e5e7eb;
...
/* Hide automatic page title; use our hero instead */
.page__title {
  display: none;
}

/* Hero header (left-aligned, academic) */
.projects-hero {
  max-width: 760px;
...
/* Intro paragraph aligned with hero width */
.projects-intro {
  max-width: 760px;
...
/* Keep main content constrained like Home */
.page__content {
  max-width: 760px;
  margin: 0 auto;
}

/* Section headings inside Projects */
.page__content h2 {
  margin-top: 2.1rem;
...
/* Figures / images (TrainOps + placeholders) */
.project-figure {
  margin: 0.85rem 0 0 0;
}

/* Single-image style (sensor / failure-mode) */
.project-figure img {
  max-width: 100%;
