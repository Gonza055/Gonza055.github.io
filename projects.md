...
- Reproducible preprocessing pipeline (smoothing, outlier capping, signal reconstruction) for noisy sensor data.
...
- Evaluation with standard metrics and visualization.
