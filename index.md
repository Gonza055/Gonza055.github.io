...
<style>
/* STANFORD-STYLE PALETTE: cardinal + neutrals */
:root {
  --home-border: #e5e7eb;
  --home-text-main: #111827;
  --home-text-muted: #6b7280;
  --home-accent: #8c1515;      /* Stanford Cardinal */
  --home-accent-soft: #b21f2d; /* Slightly lighter for hover */
}
...
/* EXPERIENCE – single-column with left border */
.exp-item {
  border-left: 3px solid rgba(140, 21, 21, 0.6);
  padding-left: 0.9rem;
...
/* TECHNICAL FOCUS – three-column grid */
.three-column {
  display: grid;
  gap: 1.5rem;
